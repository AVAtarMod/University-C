...
int main()
{
    if (isFileExist("/home/grigory/Programming/C++/Laboratory/2SST/LABW2/files/table.txt"))
    {
        std::ofstream out("/home/grigory/Programming/C++/Laboratory/2SST/LABW2/files/table.txt");
        {
            bool debug = false;
            ...
            if (!debug)
            {
                ...
                std::string example3("limonlimonlimonlimon");
                std::string example4("lol");
                std::string example5("sssssssssssssssssssssss");
                std::string example6("aaaaaaaaaab");
                std::string example7("lol");
                std::string example8("lol");
                std::string example9("lol");
                std::string example10("lol");

                std::string substr2("bac");
                std::string substr3("limon");
                std::string substr4("lol");
                std::string substr5("asssssss");
                std::string substr6("aaab");
                std::string substr7("lol");
                std::string substr8("lol");
                std::string substr9("lol");
                std::string substr10("lol");
